...
3. **Cross-reference research.** For each candidate, ask: does today's
   research note materially shift `your_p` vs market-implied `market_p`?
   Drop candidates with no informational edge.
